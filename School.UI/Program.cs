                ...
                switch (choiceMainStudent)
                {
                    case "1":
                        ...
                        try
                        {
                            ...
                            if (s!= null)
                            {
                                var @class = s.ClassId != null ? studentService.GetClassForId(s.ClassId)?.Name : "no class";
                                ...
                                Console.WriteLine($"FullName: {s.FullName}\n" +
                                                  ...
                                                  studentService.GetSubjects(s.Id).
                                                      Aggregate("\t\t", (current, subject) => current + subject.Name + "\n\t\t")
                                );
                            }
                            else
                            {
                                    ...
                                    do
                                    {
                                        ...
                                        switch (editChoice)
                                        {
                                            ...
                                            case "6":
                                                ...
                                                Console.WriteLine("Enter subjects numbers, pls input only correct value)" +
                                                                  "\nEnter 0 to stop\n");
                                    ...
                                    do
                                    {
                                        ...
                                        switch (editChoice)
                                        {
                                            ...
                                            case "2":
                                                ...
                                                Console.WriteLine("Enter student numbers to add subject, pls input only correct value\n");
                                            ...
                                            case "3":
                                                ...
                                                Console.WriteLine("Enter teachers numbers to add subject, pls input only correct value\n");
                        ...
                        do
                        {
                            ...
                            switch (choiceCrud)
                            {
                                ...
                                case "4":
                                    ...
                                    {
                                        Console.WriteLine("Error!!! Teacher wasn't created!!! Maybe you entered wrong data");
                                ...
                                case "5":
                                    ...
                                    {
                                        Console.WriteLine("You entered incorrect id and we can't found teacher to delete\n");
